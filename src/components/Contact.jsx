    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          setLoading(false);
          console.error(error);
          <Alert type="error" message="Ahh, something went wrong. Please try again." />
        }
      );
  };
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-backg py-4 px-6 placeholder:text-[#8D7B68] text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
